function draw_varianceplot(para,title_string,filename,gmmhmm_projectroot,store_path,varargin)
    ...
    for nn = 1:num_of_dists
        ...
        dist_var = [];
        for jj = 1:CLASS_NUM
            first_block = 1:SEQ_NUM_FOR_EACH_CLASS;
            jj_block = (jj-1)*SEQ_NUM_FOR_EACH_CLASS+1:jj*SEQ_NUM_FOR_EACH_CLASS;
            distances = Distance(first_block,jj_block);
